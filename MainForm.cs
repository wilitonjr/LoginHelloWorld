    ...
    public partial class MainForm : Form
    {
        ...
        private async void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(authCode))
            {
                ...
                {
                    case IdentityProvider.Okta: // Okta (Auth0)
                    ...
                    case IdentityProvider.EntraID: // Entra ID (Azure AD)
        ...
        private void btnLogout_Click(object sender, EventArgs e)
        {
            ...
            {
                client.GetAsync(IdentityProviderConfig.GetLogoutRedirectUri()).Wait();
            }
            ...
            using (var client = new HttpClient())
            {
                ...
                var tokenRequest = new HttpRequestMessage(HttpMethod.Post, tokenUrl)
                {
                    Content = new FormUrlEncodedContent(new Dictionary<string, string>
                    {
                        ...
                        { "redirect_uri", IdentityProviderConfig.GetLoginRedirectUri(currentProvider) }
                    })
                };
        ...
        private void UpdateLoginStatus(bool isLoggedIn)
        {
            if (isLoggedIn)
            {
                ...
                cmbIdentityProvider.Enabled = false;
            }
            else
            {
                ...
                cmbIdentityProvider.Enabled = true;
            }
        }
